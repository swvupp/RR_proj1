...
hist(activity_data_total$steps, col="red", xlab = "Total Steps taken each day", main = "Distribution of Total Steps taken each day")
     
barplot(height = activity_data_total$steps, names.arg = activity_data_total$date, xlab = "Date", ylab = "Total number of steps", main = "Total number of steps by Date", col = "blue")     
```
...
hist(activity_data_total_imp$steps, col="red", xlab = "Total Steps taken each day", main = "Distribution of Total Steps taken each day")
...
plot(avg_steps_per_interval_weekday$interval, avg_steps_per_interval_weekday$steps, type = 'l', col = "green", xlab = "Interval", ylab = "Average steps each day", lwd = 2.5, main = "Average steps across weekdays by interval")
```
